...
# React Front End App <a name="about-project"></a>
...
```sh
  ...
  git clone https://github.com/faisalakb/React-Front-End-App
```
...
Feel free to check the [issues page](https://github.com/faisalakb/React-Front-End-App/issues).
...
This project is [MIT](https://github.com/faisalakb/React-Front-End-App/blob/dev/LICENSE) licensed.
